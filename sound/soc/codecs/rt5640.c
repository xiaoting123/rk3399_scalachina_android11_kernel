/*
 * rt5640.c  --  RT5640/RT5639 ALSA SoC audio component driver
 *
				  ...
				  struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_component_update_bits(component, RT5640_GEN_CTRL1,
				    RT5640_M_MAMIX_L, 0);
		break;
	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_component_update_bits(component, RT5640_GEN_CTRL1,
...
static int rt5640_digital_mute(struct snd_soc_dai *dai, int mute)
{
	...
	if(flag_hdmi_xt == 0 &&  0 == gpio_get_value(67)){
		msleep(100);
...
static struct snd_soc_component_driver soc_component_dev_rt5640 = {
	.probe = rt5640_probe,
...
static int rt5640_parse_dt(struct rt5640_priv *rt5640, struct device_node *np)
{
	...
	rt5640->pdata.spk_ctl_gpio = of_get_named_gpio(np,"spk-ctl-gpio", 0);
	printk("=======================rt5640_parse_dt===================");
	/*
		    ...
		    const struct i2c_device_id *id)
{
	...
	return snd_soc_register_component(&i2c->dev, &soc_component_dev_rt5640,
